...
namespace UserAuth.Controllers
{
    ...
    {
        //This controller controls the chatroom functionality. 
        ...
        public ChatroomController(UserAuthDBContext context, UserManager<MinervaUser> userManager, IUserServices userServices)
        {
            _context = context;
            //_logger = logger;
